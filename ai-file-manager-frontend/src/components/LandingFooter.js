            ...
            <div class="flex justify-between max-w-full mx-auto">
                <div class="font-bold text-violet-500 dark:text-violet-500 text-[23px]">
                    ...
                    <span class="pl-3 space-x-3">
                        <Link href="https://github.com/" class="text-gray-400 dark:text-gray-400 text-base hover:text-blue-400 dark:hover:text-blue-400">
                ...
                <div class="text-gray-600 dark:text-gray-400 space-x-4 pt-2">
                    <Link href="#" target="_blank" rel="noopener noreferrer" class="hover:text-blue-400">Contact Us</Link>
                </div>
            </div>
        </footer>
