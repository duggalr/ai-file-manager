...
#     # root_directory = '/Users/rahulduggal/Desktop/test_directory_five'
#     root_directory = '/Users/rahulduggal/Documents/tmp_one'
#     valid_files, invalid_dirs, invalid_files = process_directory(root_directory, invalid_dirs, valid_files, invalid_files)
...
#     print(f"Number of Valid File Paths: {len(valid_files)}")
#     print(f"Number of Invalid Directories: {len(invalid_dirs)}")
#     print(f"Number of Invalid File Paths: {len(invalid_files)}")

#     print('--------------------------------------------------------')

#     for vld_fp in valid_files:
#         print(f"VALID: {vld_fp}")

#     print('--------------------------------------------------------')

#     for invld_dir in invalid_dirs:
#         print(f"Invalid Dir: {invld_dir}")

#     print('--------------------------------------------------------')

#     for invld_fp in invalid_files:
#         print(f"Invalid FP: {invld_fp}")